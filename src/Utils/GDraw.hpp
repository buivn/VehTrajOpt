...
#ifndef GP__GDRAW_HPP_
#define GP__GDRAW_HPP_
...
namespace GP
{
    ...
    void GDrawIndexColor(const int i, double rgb[] = NULL);
    
    void GDrawIndexColor(const int i, const int n, double rgb[] = NULL);
...
//2D stuff
    ...
    void GDrawIllumination(const GIllumination * const illum);
